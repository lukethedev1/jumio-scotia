...
namespace JumioLiveness SWIFT_PRIVATE_ATTR SWIFT_SYMBOL_MODULE("JumioLiveness") {
  ...
  _impl::$s13JumioLivenessAAC5resetyyFTj(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
  SWIFT_INLINE_THUNK void JumioLiveness::clean() {
  _impl::$s13JumioLivenessAAC5cleanyyFTj(::swift::_impl::_impl_RefCountedClass::getOpaquePointer(*this));
  }
